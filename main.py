...
#     label = menu.add.label(f"{top_player[0]} : {top_player[1]}")
#     table.add_row(label)
label1 = menu.add.label(f"{top_players[0][0]} : {top_players[0][1]}")
label2 = menu.add.label(f"{top_players[1][0]} : {top_players[1][1]}")
label3 = menu.add.label(f"{top_players[2][0]} : {top_players[2][1]}")
label4 = menu.add.label(f"{top_players[3][0]} : {top_players[3][1]}")
label5 = menu.add.label(f"{top_players[4][0]} : {top_players[4][1]}")
